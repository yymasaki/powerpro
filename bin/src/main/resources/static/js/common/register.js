$(function(){
	...
	$("#modal-open").click(function(){
		...
		$("#confirm-hired").text($("input[name='hiredOn']").val());
	...
	function button_status() {
		if(visible_last_name && visible_first_name && visible_hired && visible_department && visible_password && visible_check_password){
